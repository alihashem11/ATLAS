...
var style_UtilizedAgriculturalAreaha_20 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("UAA");
    var labelText = "";
    size = 0;
    ...
    if (value >= 4286.601000 && value <= 355175.830000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 355175.830000 && value <= 1041512.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1041512.000000 && value <= 2222432.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2222432.000000 && value <= 3442799.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3442799.000000 && value <= 4715138.000000) {
            style = [ new ol.style.Style({
