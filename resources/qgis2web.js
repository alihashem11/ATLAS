...
map.getView().fit([-8578134.837261, -143912.406201, 12586784.463265, 16867634.509102], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ATLAS of Agricultural Plastic Waste (APW)</h2>';
        return titleElement;
    })(),
