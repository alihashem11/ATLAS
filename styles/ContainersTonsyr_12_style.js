...
var style_ContainersTonsyr_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Containers");
    var labelText = "";
    size = 0;
    ...
    if (value >= 3.231400 && value <= 254.304542) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 254.304542 && value <= 676.566128) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 676.566128 && value <= 1196.611954) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1196.611954 && value <= 2199.055050) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2199.055050 && value <= 5035.113660) {
            style = [ new ol.style.Style({
