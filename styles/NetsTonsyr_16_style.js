...
var style_NetsTonsyr_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Nets");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 3306.731660) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3306.731660 && value <= 11738.710530) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11738.710530 && value <= 25178.469700) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25178.469700 && value <= 80639.555070) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 80639.555070 && value <= 116639.962600) {
            style = [ new ol.style.Style({
