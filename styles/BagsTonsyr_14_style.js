...
var style_BagsTonsyr_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Bags");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.918000 && value <= 1350.469700) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1350.469700 && value <= 4407.641500) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4407.641500 && value <= 9786.923900) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 9786.923900 && value <= 19976.927000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19976.927000 && value <= 28987.285000) {
            style = [ new ol.style.Style({
