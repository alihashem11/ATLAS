...
var style_IrrigationpipesTonsyr_15 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Irrigation");
    var labelText = "";
    size = 0;
    ...
    if (value >= 2.970000 && value <= 4373.173000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4373.173000 && value <= 12145.637660) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12145.637660 && value <= 26858.612500) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26858.612500 && value <= 67671.212000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 67671.212000 && value <= 98146.054000) {
            style = [ new ol.style.Style({
