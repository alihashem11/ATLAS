...
var style_TotalAPWTonsyr_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Total APW");
    var labelText = "";
    size = 0;
    ...
    if (value >= 149.290246 && value <= 6994.600132) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6994.600132 && value <= 23618.429210) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23618.429210 && value <= 54454.561430) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 54454.561430 && value <= 182877.682200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 182877.682200 && value <= 323921.289000) {
            style = [ new ol.style.Style({
